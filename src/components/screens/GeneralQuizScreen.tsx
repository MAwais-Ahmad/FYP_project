...
export function GeneralQuizScreen({
    ...
    return (
        <section className="h-screen flex flex-col p-3 md:p-4 overflow-hidden">
                ...
                <div className="flex items-center gap-2">
                    {scenario.totalTimeLimit && scenario.totalTimeLimit > 0 && (
                        <div
                            ...
                            title="Total time remaining for this test"
                        >
            ...
            {/* Question panel — full width (test details are shown before the test starts) */}
            <div className="flex-1 min-h-0 max-w-4xl w-full mx-auto glass-card p-4 md:p-6 overflow-y-auto">
                {renderQuestion()}
            </div>
